...
fn mock_block(lines: usize, padding: usize, keep_with_next: bool, can_split: bool, widow_penalty: usize) -> MeasuredFlowUnit {
    MeasuredFlowUnit {
...
fn paginator_strips_intrinsic_padding_from_elements_landing_at_the_top_of_a_page() {
    ...
    let blocks = vec![
        mock_block(54, 0, false, false, 0), // Perfectly fills Page 1 to the absolute brim
        mock_block(5, 2, false, false, 0),  // A Scene Heading-like block demanding 2 lines of padding above
    ];
...
fn paginator_prevents_stranding_blocks_that_require_keep_with_next() {
    ...
    let blocks = vec![
        mock_block(50, 0, false, false, 0), // Fills lines 1-50
...
fn paginator_splits_splittable_blocks_while_respecting_orphan_widow_limits() {
    ...
    let blocks = vec![
        mock_block(51, 0, false, false, 0), // Fills 51 lines (3 lines remaining on Page 1)
        mock_block(5, 1, false, true, 0),   // 5 line action block. Requires 1 padding. 
...
fn paginator_rejects_splits_that_violate_orphan_limits_and_pushes_entire_block() {
    ...
    let blocks = vec![
        mock_block(53, 0, false, false, 0), // Fills exactly 53 lines (1 line remaining)
        mock_block(4, 0, false, true, 0),   // 4 line block with 0 padding. can_split = true!
...
fn paginator_accounts_for_additional_widow_penalty_lines_when_splitting_dialogue() {
    ...
    let blocks = vec![
        mock_block(50, 0, false, false, 0), // Fills 50 lines (4 lines remaining on Page 1)
        mock_block(7, 1, false, true, 1),   // 7 line dialogue block with 1 line padding above.
